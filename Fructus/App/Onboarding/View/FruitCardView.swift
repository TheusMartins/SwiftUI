    ...
    var body: some View {
        ZStack {
            VStack(spacing: 20) {
                ...
                Text("Blueberrires are sweet, nutritious and wildly popular fruit all over the world.")
                    .foregroundColor(.white)
        ...
        .background(LinearGradient(gradient: Gradient(colors: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")]), startPoint: .top, endPoint: .bottom))
        .cornerRadius(20)
